<%-- 
    Document   : registroClienteNOK
    Created on : 17-06-2018, 18:50:00
    Author     : Felipe
--%>
			     ...
			     <div class="inner-header-agile">	
								<nav class="navbar navbar-default">
									<div class="navbar-header">
										...
										<h1><a  href="#"><span>R</span>esort <p class="s-log">Booking</p></a>
...
<!-- //breadcrumb -->
			<!--/content-inner-section-->
				  <div class="w3_content_agilleinfo_inner">
					    <div class="container">
							<div class="text-center inner-agile-w3l-part-head">
                                                            <h1>Ups, un error :(</h1>
                                                            <p>Ha ocurrido un error, favor intenta nuevamente.</p>
							</div>
