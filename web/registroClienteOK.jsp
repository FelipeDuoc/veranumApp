<%-- 
    Document   : registroClienteOK
    Created on : 17-06-2018, 18:46:20
    Author     : Felipe
--%>
				  ...
				  <div class="w3_content_agilleinfo_inner">
					    <div class="container">
							<div class="inner-agile-w3l-part-head">
                                                            ...
                                                            <h1 class="text-center">Cliente registrado Correctamente</h1>                                                          
                                                            <h3 class="text-center">Inicia sesión <a href="http://localhost:8080/VeranumApp/login.jsp">AQUÍ</a></h3>
							</div>
...
<!-- //for bootstrap working -->
        ...
        <h3>Haz registrado tus datos correctamente</h3>
        <h5>Inicia sesión <a href="http://localhost:8080/VeranumApp/login.jsp">AQUÍ</a></h5>
    </body>
</html>
